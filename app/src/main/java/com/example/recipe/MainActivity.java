...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipes1.add(new Recipes("Chicken Roll","1. 200 gm chopped into cubes chicken \n" +
                "2. 1 medium chopped tomato \n" +
                "3. 1/2 pinch red chilli powder \n" +
                "4. 2 tablespoon vegetable oil \n" +
                "5. 1/2 cut into strips cucumber \n" +
                "6. 1/2 tablespoon chopped coriander leaves \n" +
                "7. 1 large thinly sliced onion \n" +
                "8. 2 medium chopped green chilli \n" +
                "9. 2 pinches garam masala powder \n" +
                "10. 1 lemon wedges \n" +
                "11. 1 teaspoon tomato ketchup \n" +
                "12. 1 tablespoon green chilli sauce \n","Method",
